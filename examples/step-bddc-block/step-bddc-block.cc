...
namespace Step55
{
  ...
  void StokesProblem<dim>::setup_system()
  {
    ...
    // DoFTools::make_sparsity_pattern.
    {
      ...
      std::vector<IndexSet> active_partitioning(2);
      active_partitioning.resize(2);
    ...
    // to the construction of the system_matrix above.
    {
      ...
      active_partitioning[0] = locally_active_dofs.get_view(0, n_u);
      active_partitioning[1] = locally_active_dofs.get_view(n_u, n_u + n_p);
      preconditioner_matrix.reinit_IS(owned_partitioning,
                                      active_partitioning,
                                      owned_partitioning,
                                      active_partitioning,
                                      dsp,
  ...
  void StokesProblem<dim>::solve()
  {
    ...
    dealii::PETScWrappers::PreconditionBDDC prec_A;
    {
    ...
    dealii::PETScWrappers::PreconditionBDDC prec_S;
    {
      dealii::PETScWrappers::PreconditionBDDC::AdditionalData data;
